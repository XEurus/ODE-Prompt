...
TRAINING_MODE="bank"     # bank | realtime

# ==================== 攻击配置 ====================
ATTACK_MODE=PGD     # PGD | PGD_whitebox
TRAIN_EPS=16                  # 训练扰动强度 (x/255)
TEST_EPS=16                   # 测试扰动强度 (x/255)
TRAIN_PGD_ITERS=40            # Bank模式: 训练 PGD 迭代次数
...
PKL_DIR=./pkl_${ATTACK_MODE}_${TRAIN_PGD_ITERS}_eps${TRAIN_EPS}_${NUM_SHOTS}shot
